 ...
 * @author fernando
 */
public class JfrmIngresarCliente extends javax.swing.JFrame {

    /**
     * Creates new form JfrmIngresarCliente
     */
    public JfrmIngresarCliente() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JfrmIngresarCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JfrmIngresarCliente().setVisible(true);
            }
        });
    }
