 ...
 * @author fernando
 */
public class JfrmIngresarComic extends javax.swing.JFrame {

    /**
     * Creates new form JfrmIngresarCliente
     */
    public JfrmIngresarComic() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JfrmIngresarComic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JfrmIngresarComic().setVisible(true);
            }
        });
    }
